...
public class StartNewGameWindow extends JFrame {
    ...
    public StartNewGameWindow(GameWindow gameWindow) {
        ...
        Rectangle gameWindowBouns=gameWindow.getBounds();
        int posX=(int)(gameWindowBouns.getCenterX()-WIN_WIDTH/2);
        int posY=(int)(gameWindowBouns.getCenterY()-WIN_HEIGHT/2);
    ...
    void btnStartGame(){
        ...
        int vinLen=slWinLeght.getValue();

        gameWindow.startNewGame(gameMode,fieldSize,fieldSize,vinLen);
